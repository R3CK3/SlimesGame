...
public class PlayerMover : MonoBehaviour
{
    ...
    private void animate()
    {
        ...
        _animator.SetBool("isOnGround", !jumping && (_controller.isGrounded || _timeSinceGrounded < _coyoteTime));
    ...
    public IEnumerator StopJumping()
    {
        ...
        yield return new WaitForSeconds(_jumpingTime - 0.3f);
        jumping = false;
